...
func TestManifestTargetName(t *testing.T) {
	...
	want := []string{
		homeDir + "/Library/Application Support/Google/Chrome/NativeMessagingHosts/app.json",
		homeDir + "/Library/Application Support/Mozilla/NativeMessagingHosts/app.json",
	}
